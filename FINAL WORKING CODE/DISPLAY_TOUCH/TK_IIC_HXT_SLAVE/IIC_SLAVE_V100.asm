...
;;;;;/********************************************************************************************************//**
;;;;;* file    TK_IIC_HXT_SLAVE_V100.asm
;;;;;* brief   TK_IIC_HXT_SLAVE Code
;;;;;* version V1.00
;;;;;* date    07/25/2018
;;;;;* author  BSI
;;;;;*************************************************************************************************************
...
;;;;;************************************************************************************************************/
;;;;;/* Includes -----------------------------------------------------------------------------------------------*/
             #include "TK_IIC_HXT_SLAVE.INC"
;;;;;/*---------------------------------------------------------------------------------------------------------*/
;;;;;/*

        PUBLIC   _TK_IIC_HXT_SLAVE_INITIAL
        PUBLIC   _TK_IIC_HXT_SLAVE
        PUBLIC	 _TK_IIC_HXT_SLAVE_HALT_PREPARE
        PUBLIC   _TK_IIC_HXT_SLAVE_HALT_WAKEUP
        PUBLIC   _TK_IIC_HXT_SLAVE_RETURN_MAIN
...
;*******************************************************************
RAMBANK 0 TK_IIC_HXT_SLAVE_STANDARD_RW_RAM
TK_IIC_HXT_SLAVE_STANDARD_RW_RAM       .SECTION  'DATA'
IIC_STACK   DB 2 DUP(?)
;*******************************************************************
ifdef   PBP
ROMBANK 0 TK_IIC_HXT_SLAVE_STANDARD_RW_CODE
endif
TK_IIC_HXT_SLAVE_STANDARD_RW_CODE    .SECTION  'CODE'
...
;*************************************************************************************************************************************************
;*************************************************************************************************************************************************
RAMBANK 0 TK_IIC_HXT_SLAVE_STANDARD_RAM
TK_IIC_HXT_SLAVE_STANDARD_RAM       .SECTION  'DATA'
ifdef   PBP
...
TK_IIC_HXT_SLAVE_STANDARD_CODE    .SECTION  'CODE'
IIC_INITIAL PROC
;JMP    IIC_WRITE_ENTRY
;jmp    IIC_PRE_READ
...
ifdef   TK_IIC_HXT_SLAVE_STANDARD_FUNCTION
        JMP     TK_IIC_HXT_SLAVE_STANDARD_FUNCTION
else
        RET
endif
;*******************************************************************
...
;*******************************************************************
_TK_IIC_HXT_SLAVE_INITIAL:
        CALL    IIC_INITIAL
ifdef   TK_IIC_HXT_SLAVE_STANDARD_INITIAL
        JMP     TK_IIC_HXT_SLAVE_STANDARD_INITIAL
else
        RET
endif
